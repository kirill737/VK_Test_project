...
struct ReviewCellConfig {
    ...
    /// Объект для рендера оценки отзыва
    fileprivate let ratingRender = RatingRenderer()
}
...
private final class ReviewCellLayout {
    ...
    // DONE: Добавил в cell имя пользователя и рейтинг
    ...
    func height(config: Config, maxWidth: CGFloat) -> CGFloat {
        ...
        if showShowMoreButton {
            // TODO: настройка показать больше
